// Banco de preguntas — LATAM · Programa Alcohol y Drogas
// Fuente: "LATAM - A&D - Preguntas activación Semana de la Seguridad" (Google Doc del cliente).
...
window.PREGUNTAS = [
  ...
  },
  {
    ...
    opciones: [
      ...
      "Como medida preventiva de seguridad y salud, seguridad de las operaciones y para cumplir con normativas locales",
      "Para incentivar el consumo responsable en fiestas",
      "Únicamente como requisito médico personal"
    ],
    correcta: 1,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Afecta la visión, los reflejos y el razonamiento",
      "No tiene efecto si se duerme bien después"
    ],
    correcta: 2,
  ...
  },
  {
    ...
    opciones: [
      ...
      "En el portal interno Home LATAM → People Manager · Mis solicitudes",
      "Buscando en cualquier blog no oficial",
      "Esperando a que alguien me lo comente"
    ],
    correcta: 0,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Sustancias únicamente ilegales que generan adicción y alucinaciones, como la cocaína o el LSD",
      "Cualquier suplemento o vitamina que afecte el rendimiento físico sin alterar funciones mentales",
      "Sustancias naturales sin receta que no representan riesgo para el desempeño laboral"
    ],
    correcta: 0,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Se selecciona un grupo fijo de trabajadores definido al inicio del año",
      "Se utiliza un software que genera una muestra aleatoria, asegurando igual probabilidad para todos",
      "Los trabajadores se inscriben voluntariamente en el proceso de testeo"
    ],
    correcta: 2,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Solo mencionarlo si me toca realizarme el test de alcohol y drogas",
      "Enviar la información a Recursos Humanos",
      "No hacer nada"
    ],
    correcta: 0,
  ...
  },
  {
    ...
    opciones: [
      ...
      "A través de carta, email, teléfono o mensaje de texto",
      "Por comunicación de su sindicato",
      "En la reunión mensual del área"
    ],
    correcta: 1,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Reemplazarlo silenciosamente en sus tareas para asegurar la continuidad de la operación",
      "Notificar inmediatamente al supervisor o al área de Recursos Humanos / Salud Ocupacional para iniciar protocolos de seguridad y ofrecer apoyo",
      "Esperar hasta el final de la jornada para preguntarle si se siente bien"
    ],
    correcta: 2,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Suspensión temporal de funciones sin goce de sueldo para rehabilitación",
      "Medidas disciplinarias que pueden incluir el término del contrato laboral, por ser una falta grave",
      "La obligación de realizar trabajos comunitarios fuera de la jornada laboral"
    ],
    correcta: 2,
  ...
  },
  {
    ...
    opciones: [
      ...
      "Enfocarse en áreas de trabajo que históricamente han tenido más incidentes",
      "Garantizar la equidad y objetividad, al dar la misma probabilidad de selección a todos los trabajadores",
      "Medir la prevalencia de consumo de sustancias psicoactivas en toda la población laboral"
    ],
    correcta: 2,
    explicacion: "El software garantiza igual probabilidad para todos y total aleatoriedad. Esto promueve la transparencia y elimina el sesgo en la selección."
  }
];
